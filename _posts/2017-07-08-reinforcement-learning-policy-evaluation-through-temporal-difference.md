...
We are approximating an average value _by averaging its values_. That makes total sense, right? The thing is the world is not that simple: the fact that we are taking many steps before finishing an episode and being able to update our estimates introduces a high amount of _variance_ into the updates.
